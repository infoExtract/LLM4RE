...
def main(args):
    ...
    #     k_list = [0]
    # for k in k_list:
    if args.demo == 'zero' and args.k != 0:
        print('Wrong K Value. Terminating....')
        sys.exit(1)
    ...
    print(f'Evaluating Shot - {args.k}')
    for data_seed in [100, 13, 42]:
        ...
        if args.model != 'OpenAI/gpt-4o-mini':
            ...
            outpath = f'{args.out_path}/RC/{args.model}/{args.task}/{args.demo}/seed-{data_seed}/input'
...
if __name__ == "__main__":
    ...
    parser.add_argument('--prompt', type=str, default='open', choices=['open', 'entrel', 'rel', 'ent'],
                        help="Prompt Type")
    ...
    parser.add_argument('--model', '-m', type=str, default='meta-llama/Meta-Llama-3.1-8B-Instruct', required=False,
                        help="LLM")
    parser.add_argument('--k', type=int, choices=[0,5,10,20], required=False,
                        help="k-shot")
